...
<head>
    ...
    <style>
        body {
            ...
            background: url('srm.jpeg') no-repeat center center fixed;
...
<body>
    ...
    <div class="chefs-container">
        ...
        <div class="chef-card">
            <img src="chef_cheruba.jpeg" alt="Chef Cheruba">
            <div class="chef-details">
                <h1>Miss Cheruba</h1>
                <h2>Designation: Pastry Chef</h2>
                <h3>Experience: 3 years</h3>
        ...
        <div class="chef-card">
            <img src="chef_dhamu.jpeg" alt="Chef Dhamu">
            <div class="chef-details">
                <h1>Mr. Dhamu</h1>
...
```
## OUTPUT:
![alt text](<Screenshot 2025-05-18 212034.png>)

![alt text](<Screenshot 2025-05-18 212146.png>)

![alt text](<Screenshot 2025-05-18 212221.png>)

![alt text](<Screenshot 2025-05-18 212442.png>)
